...
export class SdamGiaClient {
     ...
     */
    async getProblemById(subject, id) {
     ...
     */
    async searchProblems(subject, query, limit = 20) {
        const baseUrl = this.getBaseUrl(subject);
     ...
     * Endpoint: /test?id={id}
     */
    async getTestById(subject, testId) {
        const baseUrl = this.getBaseUrl(subject);
     ...
     */
    async getCategoryProblems(subject, categoryId, limit = 50) {
        const baseUrl = this.getBaseUrl(subject);
        const url = `${baseUrl}/prob_catalog`;
        try {
            const response = await this.axiosInstance.get(url, {
     ...
     */
    normalizeImageUrl(baseUrl, imageUrl) {
...
//# sourceMappingURL=sdamgia-client.js.map