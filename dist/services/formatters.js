 ...
 */
export function formatProblemMarkdown(problem) {
 ...
 */
export function formatProblemIdsMarkdown(ids, title = "Problem IDs") {
    let output = `# ${title}\n\n`;
 ...
 */
export function formatCatalogMarkdown(catalog) {
 ...
 */
export function formatSearchResultsMarkdown(query, results, subject) {
 ...
 */
export function formatBatchProblemsMarkdown(problems) {
